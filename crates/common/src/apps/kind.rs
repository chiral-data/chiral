...
pub enum Kind {
    ...
    OpenBabelSimilaritySearching(crate::apps::chem::kinds::Fingerprint),
...
mod tests {
    ...
    #[test]
    fn test_strum() {
        assert_eq!(Kind::OpenBabelSimilaritySearching(crate::apps::chem::kinds::Fingerprint::kind_openbabel_ecfp4(1024)).to_string(), "ob_sim");
